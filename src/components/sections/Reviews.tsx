              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full overflow-hidden bg-gray-200 relative">
                    ...
                    <div className="absolute inset-0 bg-[#d6f871] flex items-center justify-center text-white text-xl font-bold">
                ...
                <div className="flex gap-2">
                  <button 
                    className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-[#d6f871]/20 hover:text-[#d6f871] transition"
                    onClick={handlePrev}
                  >
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-xl h-[500px] bg-gradient-to-br from-gray-50 to-gray-100">
                ...
                <div className="bg-white bg-opacity-90 backdrop-blur-sm p-4 rounded-tl-xl">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-[#d6f871] flex items-center justify-center text-white font-bold text-xs">
                        CA
                      </div>
                    ...
                    <div className="flex items-center gap-1">
                      <svg className="w-4 h-4 text-[#d6f871]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="relative h-full">
                <div className="absolute inset-0 bg-[#d6f871]/10 bg-opacity-30">
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all ${
                index === currentTestimonial ? 'bg-[#d6f871] w-6' : 'bg-gray-300'
              }`}
